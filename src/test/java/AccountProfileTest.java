...
public class AccountProfileTest {
    ...
    @Test
    public void checkGoToAccountProfilePageTest(){
        ...
        boolean actual = accountProfile.checkEmailField();
        Assert.assertEquals("Пользователь не в личном кабинете",expected, actual);
    }
